...
function movementDetector(neonLayts, num){
    if (num === 1) {
        if (isBlurEnabled1) {
            neonLayts.style.filter = 'blur(30px)'; // Fix: Replace 'neonLayts' with 'neonLayts1'
        }
    } else if (num === 2) {
        if (isBlurEnabled2) {
            neonLayts.style.filter = 'blur(30px)'; // Fix: Replace 'neonLayts' with 'neonLayts2'
        }
    } else if (num === 3) {
        if (isBlurEnabled3) {
            neonLayts.style.filter = 'blur(30px)'; // Fix: Replace 'neonLayts' with 'neonLayts3'
        }
    } else if (num === 4) {
        if (isBlurEnabled4) {
            neonLayts.style.filter = 'blur(30px)'; // Fix: Replace 'neonLayts' with 'neonLayts4'
        }
    } else if (num === 5) {
        if (isBlurEnabled5) {
            neonLayts.style.filter = 'blur(30px)'; // Fix: Replace 'neonLayts' with 'neonLayts5'
        }
    }
}
...
function toggleBlurEffect(container, submitButton, neonLayts, descript, num) {
    if (num === 1) {
        ...
        if (isBlurEnabled1) {
            ...
            neonLayts.style.height = (container.scrollHeight) + "px";
